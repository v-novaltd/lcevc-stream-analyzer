...
enum class InputType
{
    ...
    ES,    // LCEVC is embedded as SEI data or interleaved with base NAL units.
...
{
    switch (type) {
        case InputType::TS: return "TS";
        case InputType::ES: return "ES";
        case InputType::WEBM: return "WEBM";
